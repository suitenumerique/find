...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            default=False,
            help=(
                "If True the index is dropped and recreated from scratch before evaluation even if it already exists."
            ),
        )
    ...
    def overwrite_settings():
        ...
        settings.RERANKER_API_KEY = "jina_c5ac194f6fc943a1aab403b8acaa42ecAAQJZ4PyIy1FVVwA38wyt13R5QER"
